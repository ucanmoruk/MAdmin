...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>MASS Portal | Profil</title>
...
<%--                <img class="sidebar-card-illustration mb-2" src="img/favicon.png" alt="">--%>
 ...
 <h6 class="m-0 font-weight-bold text-primary">Firma Bilgileriniz</h6>
 </div>
 <div class="card-body">    
  ...
  <span class="input-group-text" id="basic-addon3">Vergi Dairesi - Vergi/TC No:</span>
    ...
    <div class="input-group-prepend btn-right">
        <asp:Button ID="Btn_Firma"  class="btn btn-success btn-right" runat="server" Text="Güncelle" OnClick="Btn_Firma_Click" />
    </div></div>
...
<asp:Button ID="Button1" runat="server" class="close"  Text="x" OnClick="Btn_kapat2_Click"></asp:Button>
    <center><strong>Bilgileriniz başarı ile güncellendi!</strong> </center>
  </div> </div>
   ...
   <div class="row">
        ...
        <div class="card shadow mb-4">
 <div class="card-header py-3">
 <h6 class="m-0 font-weight-bold text-primary">Parola</h6>
 </div>
 <div class="card-body">    

    <div class="input-group mb-3">                         
    <div class="input-group-prepend">
    <span class="input-group-text" id="basic-1">Eski Parola:&nbsp;&nbsp;&nbsp;&nbsp;</span> </div>  
    <asp:TextBox id="Txt_old" type="password" class="form-control"  runat="server" /> </div>

     <div class="input-group mb-3">                         
    <div class="input-group-prepend">
    <span class="input-group-text" id="basic-2">Yeni Parola:&nbsp;&nbsp;&nbsp;</span> </div>  
    <asp:TextBox id="Txt_new1" type="password" class="form-control"  runat="server" /> </div>
    ...
    <asp:TextBox id="Txt_new2" type="password" class="form-control"  runat="server" /> </div>
     ...
     <div class="input-group mb-3">                         
    <div class="input-group-prepend">
        <asp:Button ID="btn_parola"  class="btn btn-success" runat="server" Text="Parola Güncelle" OnClick="btn_parola_Click" />
    </div></div>
...
<asp:Button ID="Btn_kapat" runat="server" class="close"  Text="x" OnClick="Btn_kapat_Click"></asp:Button>
    <center><strong>Parolanız başarı ile güncellendi!</strong> </center>
  </div> </div>

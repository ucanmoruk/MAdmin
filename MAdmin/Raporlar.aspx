...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Mass | Test Raporları</title>
                                         ...
                                         <asp:GridView ID="GridView1" class="table table-bordered" runat="server" 
                                             ...
                                             <Columns>
                                                 <asp:TemplateField HeaderText="Rapor No">
                                                     <ItemTemplate>
                                                              <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("RaporNo") %>'></asp:Literal>    
                                                     </ItemTemplate>
                                                 </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="&#220;r&#252;n T&#252;r&#252;">
                                                     <ItemTemplate>
                                                              <asp:Literal ID="Literal2" runat="server" Text='<%# Eval("Tur") %>'></asp:Literal>    
                                                     </ItemTemplate>
                                                 </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Marka">
                                                     <ItemTemplate>
                                                              <asp:Literal ID="Literal3" runat="server" Text='<%# Eval("Marka") %>'></asp:Literal>    
                                                     </ItemTemplate>
                                                 </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Model">
                                                     <ItemTemplate>
                                                              <asp:Literal ID="Literal4" runat="server" Text='<%# Eval("Model") %>'></asp:Literal>    
                                                     </ItemTemplate>
                                                 </asp:TemplateField>
